            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link <?php echo base_url('assets/assets_customer2/') ?> js-scroll-trigger" href="#contact">Login</a></li>
                        <li class="nav-link"><a href="<?php echo base_url('customer2/registrasi') ?>">Registrasi</a></li>
                    </ul>
                </div>
            </div>
        </nav>
